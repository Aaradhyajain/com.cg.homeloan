...
public class FinanceVerificationOfficerController {
	...
	public ResponseEntity<LoanApplication> updateFinanceStatus(@RequestBody LoanApplication loanApplication) throws FinanceVerificationException {
		return new ResponseEntity<LoanApplication>(financeVerificationService.updateStatus(loanApplication), HttpStatus.OK);
	...
	public ResponseEntity<Boolean> isValidFinanceOfficer(@PathVariable String username,@PathVariable String password) {
		return new ResponseEntity<Boolean>(financeVerificationService.isValidFinanceOfficer(username, password),HttpStatus.OK);
	}
