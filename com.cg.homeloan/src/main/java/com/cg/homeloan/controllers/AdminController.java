...
public class AdminController {
	...
	public ResponseEntity<Admin> getAdmin(@PathVariable("userId") int userId) {
		return new ResponseEntity<Admin>(adminService.getAdmin(userId), HttpStatus.FOUND);
	}
	...
	public ResponseEntity<FinanceVerificationOfficer> addFinanceOfficer(
			@RequestBody FinanceVerificationOfficer officer) {
		return new ResponseEntity<FinanceVerificationOfficer>(financeVerificationService.addFinanceOfficer(officer),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<LandVerificationOfficer> addLandOfficer(@RequestBody LandVerificationOfficer officer) {
		return new ResponseEntity<LandVerificationOfficer>(landVerificationService.addLandOfficer(officer),
				HttpStatus.OK);
	}
